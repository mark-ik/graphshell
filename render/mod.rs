...
mod spatial_index;
#[cfg(test)]
use panels::history_manager_entry_limit_for_tests;
pub use panels::{render_help_panel, render_history_manager_in_ui};
...
mod legacy_panels {
    use super::*;
    use crate::app::{HistoryCaptureStatus, HistoryManagerTab, ReducerDispatchContext, WorkbenchIntent};
    ...
    fn selected_node_dynamics_profile_id(app: &GraphBrowserApp) -> String {
        ...
        {
            return crate::registries::atomic::lens::physics_profile_id(&view.lens.physics)
                .to_string();
        }
    ...
    fn render_physics_settings_in_ui(ui: &mut Ui, app: &mut GraphBrowserApp) {
        ...
        ui.small(
            "Liquid/Gas/Solid control node motion behavior. They do not control camera policy.",
        );
    ...
    fn render_camera_controls_settings_in_ui(ui: &mut Ui, app: &mut GraphBrowserApp) {
        ...
        ui.small(
            "`C` toggles position lock. `Z` toggles zoom lock. Locks are per active graph view.",
        );
                    ...
                    .show(ui, |ui| {
                        egui::Grid::new("shortcut_grid")
                            ...
                            .show(ui, |ui| {
                                ...
                                let command_palette_key =
                                    match app.workspace.command_palette_shortcut {
                ...
                match app.workspace.settings_tool_page {
                    ...
                    crate::app::SettingsToolPage::Persistence => {
                        ...
                        ui.horizontal(|ui| {
                            ...
                            if ui
                                .add(
                                    egui::TextEdit::singleline(&mut interval_input)
                                        .desired_width(80.0),
                                )
                                .changed()
                            {
                        ...
                        if ui.button("Save Current Frame").clicked() {
                            let now = SystemTime::now()
                                ...
                                .map(|d| d.as_secs())
                                .unwrap_or(0);
                            app.request_save_frame_snapshot_named(format!(
                                "workspace:toolpane-{now}"
                            ));
                        }
                    ...
                    crate::app::SettingsToolPage::Appearance => {
                        ...
                        ui.small(
                            "Press F9 to jump directly to Camera Controls in Physics settings.",
                        );
                    }
                }
            });
...
pub fn render_file_tree_tool_pane_in_ui(
    ...
    legacy_panels::render_file_tree_tool_pane_in_ui(ui, app)
}
...
pub fn render_settings_tool_pane_in_ui_with_control_panel(
    ...
    legacy_panels::render_settings_tool_pane_in_ui_with_control_panel(ui, app, control_panel)
}
