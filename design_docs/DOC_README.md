...
- [graphshell_docs/implementation_strategy/canvas/CANVAS.md](graphshell_docs/implementation_strategy/canvas/CANVAS.md) - Graph domain spec at the canvas surface: truth, analysis, management, and graph-bearing projections.
