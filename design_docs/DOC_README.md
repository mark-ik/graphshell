...
- [graphshell_docs/implementation_strategy/2026-03-01_webrender_readiness_gate_feature_guardrails.md](graphshell_docs/implementation_strategy/2026-03-01_webrender_readiness_gate_feature_guardrails.md) - **DEFERRED INDEFINITELY (2026-03-12)** WebRender readiness gate and feature guardrails for `#183`. wgpu renderer migration suspended; Graphshell ships on egui_glow.
