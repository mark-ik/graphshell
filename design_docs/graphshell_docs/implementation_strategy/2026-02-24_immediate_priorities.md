...
| 8 | **Progressive Lenses + Lens/Physics binding policy** *(strategy doc written — see `2026-02-25_progressive_lens_and_physics_binding_plan.md`)* | Makes Lens abstraction feel native and semantic, not static presets. | `2026-02-24_interaction_and_semantic_design_schemes.md`, `2026-02-24_physics_engine_extensibility_plan.md` (lens-physics binding preference), `2026-02-25_progressive_lens_and_physics_binding_plan.md` | Policy resolved. Implement after Lens resolution is active runtime path and physics presets are distinct in behavior (see §4 of strategy doc). |
