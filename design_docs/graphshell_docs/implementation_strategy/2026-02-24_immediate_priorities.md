...
| 6 | **Graph Reader ("Room" + "Map" linearization) and list-view fallback** | Critical accessibility concept beyond the initial webview bridge; gives non-visual users graph comprehension. Concrete modes, entry points, and AccessKit output shape are now defined in `2026-02-24_spatial_accessibility_plan.md` Phase 2. | `2026-02-24_spatial_accessibility_research.md`, `2026-02-24_spatial_accessibility_plan.md` §Phase 2 (§2.1–2.4) | After Phase 1 WebView Bridge lands. |
...
| 10 | **Interactive HTML Export (self-contained graph artifact)** | Strong shareability and offline review workflow; distinctive output mode. | `2026-02-25_interactive_html_export_plan.md` (adopted from archived concept in `design_docs/archive_docs/checkpoint_2026-01-29/PROJECT_PHILOSOPHY.md`) | After viewer/content model and export-safe snapshot shape are defined. |
...
1. ✅ Pane-hosted multi-view architecture doc+type sync (graph/viewer/tool pane model) — complete (2026-02-25)
