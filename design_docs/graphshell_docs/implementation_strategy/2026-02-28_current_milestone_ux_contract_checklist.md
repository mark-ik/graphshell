...
- [x] `#118` `gui.rs` responsibility split reduces orchestration ambiguity where needed
- [x] `#119` `gui_frame.rs` responsibility split reduces frame lifecycle ambiguity where needed
