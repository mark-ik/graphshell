...
| Focus/Selection Interaction Contract deliverable | UX integration research §10 D2 | `subsystem_focus/focus_and_region_navigation_spec.md`, `workbench/workbench_frame_tile_interaction_spec.md` | Green | Pass | `#293` deliverable contract merged (selection scope, ownership map, handoff/arbitration rules, checklist + test references); keep runtime predictability hardening tracked in `#300` |
| Surface Behavior Spec deliverable | UX integration research §10 D3 | `../design/surface_behavior_spec.md`, command/workbench/viewer specs | Green | Pass | `#294` canonical surface behavior spec is merged with policy + implementation checklist; discoverability follow-through remains tracked in `#297` |
| Accessibility Baseline Checklist deliverable | UX integration research §10 D4 | `../design/accessibility_baseline_checklist.md`, `subsystem_accessibility/SUBSYSTEM_ACCESSIBILITY.md`, focus/viewer specs | Green | Pass | `#295` canonical WCAG A/AA checklist is merged with initial screen-reader matrix; graph accessibility implementation closure remains tracked in `#298` + `#301` |
