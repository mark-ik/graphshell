...
- `2026-02-22_workbench_tab_semantics_overlay_and_promotion_plan.md` — execution note for the still-planned `FrameTabSemantics` overlay work; canonical semantic-tab contract lives in `../graph/multi_view_pane_spec.md §7`
