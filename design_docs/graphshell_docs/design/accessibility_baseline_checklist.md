...
| 3.2.2 On Input | A | Untested | Untested | Untested | Untested | Untested | Untested | Untested | Input-change side effects need confirmation across settings/filters. Partial evidence now covers deterministic omnibar submit-dispatch gating and dialog clear-confirm action classification (arm/execute/re-arm) via explicit unit regressions (2026-03-04 addendum); broader surface validation remains pending. |
...
| 3.3.1 Error Identification | A | Untested | Untested | Untested | Untested | Untested | Untested | Untested | Error identification policy exists; runtime conformance pending audit. Partial evidence now covers deterministic clipboard failure-message prefixing and explicit missing-node failure wording in `gui_orchestration` regressions (2026-03-04 addendum), while broader multi-surface validation remains pending. |
| 3.3.2 Labels or Instructions | A | Untested | Untested | Untested | Untested | Untested | Untested | Untested | Verify forms/inputs provide explicit labels and instructions. Baseline copy invariants are now test-covered for omnibar hint text and clear-data dialog warning/success messaging (2026-03-04 addendum), with full multi-surface validation still pending. |
| 3.3.3 Error Suggestion | A | Untested | Untested | Untested | Untested | Untested | Untested | Untested | Recovery suggestion quality varies; requires per-surface tests. Partial evidence now covers explicit clipboard missing-node recovery guidance (`select a node and try again`) via `gui_orchestration` regression coverage (2026-03-04 addendum), while broader multi-surface validation remains pending. |
