...
//!
//! The portable receiver state and drain helpers live in
//! [`graphshell_runtime::frame_inbox`]. This module owns only the
//! ControlPanel-driven subscription wiring that translates registry/lifecycle
//! signals into receiver sends.
...
/// Shell-side alias used by the egui-host gui module.
