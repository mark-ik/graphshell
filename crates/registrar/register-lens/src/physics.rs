...
// Slice 66: source physics types from graph_canvas::physics_config
// (their canonical home post-Slice-65) and ForceDirectedState
// (alias GraphPhysicsState) directly from graph_canvas::layout.
// This makes lens portable from the graph::physics dimension.
use graph_canvas::layout::ForceDirectedState as GraphPhysicsState;
use graph_canvas::physics_config::{
    apply_graph_physics_tuning, DegreeRepulsionConfig, DomainClusteringConfig,
    GraphPhysicsExtensionConfig, GraphPhysicsTuning, HubPullConfig, SceneCollisionPolicy,
