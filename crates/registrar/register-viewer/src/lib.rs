...
//!
//! Imports rerouted to portable crates:
//! - `register_layout::CapabilityDeclaration` (Slice 55)
//! - `graphshell_core::verso_address::VersoAddress` (Slice 56)
//! - `graphshell_core::address::AddressKind` /
//!   `address_kind_from_url` (already portable in graphshell-core)

use std::collections::HashMap;

use graphshell_core::address::{address_kind_from_url, AddressKind};
use graphshell_core::verso_address::VersoAddress;
...
mod tests {
    use super::*;
    use graphshell_core::verso_address::GraphshellSettingsPath;
