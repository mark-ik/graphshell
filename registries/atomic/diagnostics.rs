...
use crate::shell::desktop::runtime::registries::{
    ...
    CHANNEL_ACTION_EXECUTE_SUCCEEDED, CHANNEL_AGENT_INTENT_DROPPED, CHANNEL_AGENT_SPAWNED,
    CHANNEL_CANVAS_PROFILE_ACTIVATED, CHANNEL_COMPOSITOR_CONTENT_CULLED_OFFVIEWPORT,
    CHANNEL_COMPOSITOR_CONTENT_PASS_REGISTERED, CHANNEL_COMPOSITOR_DEGRADATION_GPU_PRESSURE,
    ...
    CHANNEL_COMPOSITOR_OVERLAY_PASS_REGISTERED, CHANNEL_COMPOSITOR_OVERLAY_STYLE_CHROME_ONLY,
    CHANNEL_COMPOSITOR_OVERLAY_STYLE_RECT_STROKE, CHANNEL_COMPOSITOR_PAINT_NOT_CONFIRMED,
    ...
    CHANNEL_COMPOSITOR_VIEWER_SURFACE_PATH_SHARED_WGPU, CHANNEL_DIAGNOSTICS_CHANNEL_REGISTERED,
    ...
    CHANNEL_HISTORY_TRAVERSAL_RECORDED, CHANNEL_IDENTITY_KEY_GENERATED,
    CHANNEL_IDENTITY_KEY_LOADED, CHANNEL_IDENTITY_KEY_UNAVAILABLE, CHANNEL_IDENTITY_SIGN_FAILED,
    CHANNEL_IDENTITY_SIGN_STARTED, CHANNEL_IDENTITY_SIGN_SUCCEEDED,
    CHANNEL_IDENTITY_TRUST_STORE_LOAD_FAILED, CHANNEL_IDENTITY_VERIFY_FAILED,
    CHANNEL_IDENTITY_VERIFY_STARTED, CHANNEL_IDENTITY_VERIFY_SUCCEEDED, CHANNEL_INDEX_SEARCH,
    CHANNEL_INPUT_BINDING_CONFLICT, CHANNEL_INPUT_BINDING_MISSING, CHANNEL_INPUT_BINDING_REBOUND,
    CHANNEL_INPUT_BINDING_RESOLVED, CHANNEL_INVARIANT_TIMEOUT, CHANNEL_KNOWLEDGE_INDEX_UPDATED,
    CHANNEL_KNOWLEDGE_TAG_VALIDATION_WARN, CHANNEL_LAYOUT_COMPUTE_FAILED,
    CHANNEL_LAYOUT_COMPUTE_STARTED, CHANNEL_LAYOUT_COMPUTE_SUCCEEDED,
    ...
    CHANNEL_MOD_ROLLBACK_SUCCEEDED, CHANNEL_MOD_UNLOAD_FAILED, CHANNEL_NOSTR_RELAY_CONNECT_FAILED,
    ...
    CHANNEL_PRESENTATION_PROFILE_RESOLVED, CHANNEL_PROTOCOL_RESOLVE_FAILED,
    CHANNEL_PROTOCOL_RESOLVE_FALLBACK_USED, CHANNEL_PROTOCOL_RESOLVE_STARTED,
    CHANNEL_PROTOCOL_RESOLVE_SUCCEEDED, CHANNEL_REGISTER_SIGNAL_ROUTING_FAILED,
    CHANNEL_REGISTER_SIGNAL_ROUTING_LAGGED, CHANNEL_REGISTER_SIGNAL_ROUTING_MOD_WORKFLOW_ROUTED,
    ...
    CHANNEL_RUNTIME_CACHE_MISS, CHANNEL_STARTUP_CONFIG_SNAPSHOT,
    ...
    CHANNEL_STARTUP_SELFCHECK_REGISTRIES_LOADED, CHANNEL_STARTUP_VERSE_INIT_FAILED,
    ...
    CHANNEL_THEME_ACTIVATED, CHANNEL_UI_CLIPBOARD_COPY_FAILED,
    ...
    CHANNEL_UI_COMMAND_SURFACE_ROUTE_FALLBACK, CHANNEL_UI_COMMAND_SURFACE_ROUTE_NO_TARGET,
    CHANNEL_UI_COMMAND_SURFACE_ROUTE_RESOLVED, CHANNEL_UI_HISTORY_MANAGER_LIMIT,
    ...
    CHANNEL_UX_FACET_FILTER_TYPE_MISMATCH, CHANNEL_UX_FIRST_USE_PROMPT_SHOWN,
    ...
    CHANNEL_UX_RADIAL_OVERFLOW, CHANNEL_UX_SNAPSHOT_WRITTEN, CHANNEL_UX_STRUCTURAL_VIOLATION,
    CHANNEL_UX_TREE_BUILD, CHANNEL_UX_TREE_SNAPSHOT_BUILT, CHANNEL_VERSE_PREINIT_CALL,
    ...
    CHANNEL_VIEWER_CAPABILITY_PARTIAL, CHANNEL_VIEWER_FALLBACK_USED,
    ...
    CHANNEL_WORKBENCH_SURFACE_PROFILE_ACTIVATED, CHANNEL_WORKFLOW_ACTIVATED,
};
