...
use crate::shell::desktop::runtime::registries::{
    ...
    CHANNEL_COMPOSITOR_NATIVE_OVERLAY_RECT_MISMATCH,
    ...
    CHANNEL_COMPOSITOR_TILE_ACTIVITY, CHANNEL_DIAGNOSTICS_CHANNEL_REGISTERED,
    ...
    CHANNEL_UX_EMBEDDED_FOCUS_RECLAIM, CHANNEL_UX_FACET_FILTER_APPLIED,
    CHANNEL_UX_FACET_FILTER_CLEARED, CHANNEL_UX_FACET_FILTER_EVAL_FAILURE,
    CHANNEL_UX_FACET_FILTER_INVALID_QUERY, CHANNEL_UX_FACET_FILTER_TYPE_MISMATCH,
    ...
    CHANNEL_UX_PRESENTATION_BOUNDS_MISSING, CHANNEL_UX_PROBE_REGISTERED,
    CHANNEL_UX_RADIAL_LABEL_COLLISION, CHANNEL_UX_RADIAL_LAYOUT,
    CHANNEL_UX_RADIAL_MODE_FALLBACK, CHANNEL_UX_RADIAL_OVERFLOW, CHANNEL_UX_STRUCTURAL_VIOLATION,
...
const PHASE3_CHANNELS: [DiagnosticChannelDescriptor; 151] = [
    DiagnosticChannelDescriptor {
