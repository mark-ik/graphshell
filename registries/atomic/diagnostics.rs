...
use crate::shell::desktop::runtime::registries::{
    ...
    CHANNEL_INDEX_SEARCH, CHANNEL_INPUT_BINDING_CONFLICT, CHANNEL_INPUT_BINDING_MISSING,
    CHANNEL_INPUT_BINDING_REBOUND, CHANNEL_INPUT_BINDING_RESOLVED, CHANNEL_INVARIANT_TIMEOUT,
    ...
    CHANNEL_LAYOUT_COMPUTE_SUCCEEDED, CHANNEL_LAYOUT_DOMAIN_PROFILE_RESOLVED,
    CHANNEL_LAYOUT_FALLBACK_USED, CHANNEL_LENS_FALLBACK_USED, CHANNEL_LENS_RESOLVE_FAILED,
    CHANNEL_LENS_RESOLVE_SUCCEEDED, CHANNEL_MOD_DEPENDENCY_MISSING, CHANNEL_MOD_LOAD_FAILED,
    CHANNEL_MOD_LOAD_STARTED, CHANNEL_MOD_LOAD_SUCCEEDED, CHANNEL_NOSTR_RELAY_CONNECT_FAILED,
...
const PHASE3_CHANNELS: [DiagnosticChannelDescriptor; 140] = [
    DiagnosticChannelDescriptor {
