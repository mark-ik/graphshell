...
use crate::shell::desktop::runtime::registries::{
    ...
    CHANNEL_UX_CONTRACT_WARNING, CHANNEL_UX_NAVIGATION_TRANSITION, CHANNEL_UX_NAVIGATION_VIOLATION,
    CHANNEL_UX_PROBE_DISABLED, CHANNEL_UX_PROBE_REGISTERED, CHANNEL_UX_RADIAL_LABEL_COLLISION,
    CHANNEL_UX_RADIAL_LAYOUT, CHANNEL_UX_RADIAL_MODE_FALLBACK, CHANNEL_UX_RADIAL_OVERFLOW,
    ...
    CHANNEL_PRESENTATION_PROFILE_RESOLVED, CHANNEL_THEME_ACTIVATED,
};
...
const PHASE3_CHANNELS: [DiagnosticChannelDescriptor; 113] = [
    DiagnosticChannelDescriptor {
