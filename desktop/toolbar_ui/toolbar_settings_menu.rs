...
pub(super) fn render_settings_menu(
    ...
    if ui
        .button(if graph_app.show_history_manager {
    ...
    ui.label(format!(
        "Toasts: {}",
        super::toast_anchor_label(graph_app.toast_anchor_preference)
    ));
    for anchor in [
    ...
    ui.label(format!(
        "Lasso: {}",
        super::lasso_binding_label(graph_app.lasso_mouse_binding)
    ));
    ...
    ui.label(format!(
        "Command Palette: {}",
        super::command_palette_shortcut_label(graph_app.command_palette_shortcut)
    ));
    ...
    ui.label(format!(
        "Help: {}",
        super::help_shortcut_label(graph_app.help_panel_shortcut)
    ));
    ...
    ui.label(format!(
        "Radial: {}",
        super::radial_shortcut_label(graph_app.radial_menu_shortcut)
    ));
    ...
    ui.label(format!(
        "Preferred Scope: {}",
        super::omnibar_preferred_scope_label(graph_app.omnibar_preferred_scope)
    ));
    for scope in [
    ...
    ui.label(format!(
        "Non-@ Order: {}",
        super::omnibar_non_at_order_label(graph_app.omnibar_non_at_order)
    ));
    for order in [
