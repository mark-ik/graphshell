...
use super::super::NavigatorSidebarSidePreference;
use super::super::{
...
pub struct ChromeUiState {
    ...
    pub focus_ring_settings: super::super::FocusRingSettings,
    ...
    pub thumbnail_settings: super::super::ThumbnailSettings,
